...
public class QRCodeEncoder {
    ...
    public static Bitmap syncEncodeBarcode(String content, int width, int height, int textSize) {
        Bitmap bitmap = null;
        if (content != null) {
            bitmap = syncEncodeBarcode(content, width, height, textSize, BarcodeFormat.CODE_128);
        }
        return bitmap;
    }

    public static Bitmap syncEncodeBarcodeEan13(String content, int width, int height, int textSize) {
        Bitmap bitmap = null;
        if (content != null && content.length() == 13) {
            bitmap = syncEncodeBarcode(content, width, height, textSize, BarcodeFormat.EAN_13);
        }
        return bitmap;
    }
     ...
     * @return 返回生成条形的位图
     */
    private static Bitmap syncEncodeBarcode(String content, int width, int height, int textSize, BarcodeFormat barcodeFormat) {
