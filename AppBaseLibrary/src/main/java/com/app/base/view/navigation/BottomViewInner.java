...
public class BottomViewInner extends BottomNavigationView {
    ...
    public BottomViewInner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BottomViewInner(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mMenuView.updateMenuView();
     ...
     * @param viewPager
     */
    public BottomViewInner setupWithViewPager(final ViewPager viewPager) {
     ...
     */
    public BottomViewInner setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
     ...
     * necessary calls back to the provided {@link BottomViewInner} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomViewInner> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(BottomViewInner bnve) {
        ...
        public void onPageSelected(final int position) {
            final BottomViewInner bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomViewInner bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
